...
def test_working_copy_edit(cli_runner, data_working_copy, monkeypatch, requires_pdal):
    ...
    with data_working_copy("point-cloud/auckland.tgz") as (repo_path, wc_path):
        ...
        assert r.stdout.splitlines() == [
            ...
            '-                             points.count = 1558',
            '+                             points.count = 4231',
            '-                                      oid = sha256:fb3e7465a6bf90801ef18b24ed2efccdfb6035d16e4bffbb73546cc5d56973c0',
            '+                                      oid = sha256:37a7e84e78248f6fa2faea73a12d0a37883439741b88cc61aaf36ea94bdafe52',
            '-                                     size = 24507',
            '+                                     size = 69561',

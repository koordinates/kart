...
The kart_cli_helper encodes all environment variable values using Base64
before serializing to JSON. This ensures that environment variables containing
invalid UTF-8 sequences do not cause the helper to crash.

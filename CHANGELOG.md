...
- Kart now shows diffs to attached files that have been created using `kart commit-files`, if any, and patches can edit these files [#583](https://github.com/koordinates/kart/issues/583)
